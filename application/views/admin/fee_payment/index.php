									...
									<div>
	          							...
	          							<form class="form-inline" method="GET">
										    <div class="form-group">
										      <a  data-toggle="modal" data-target="#modal-create" href="" class=" btn btn-primary form-control" title="Add New Fee Payment" style="border-radius: 0px"><i class="fa fa-plus" aria-hidden="true"></i> Add New Fee Payment</a>
										    </div>
										  </form>


											<p style="color:red;"><?php echo isset($_fee_payment['msg'])?$_fee_payment['msg']:'';?></p>
									...
									<table class="table table-bordered table-striped table-hover  dataTable" id="example" >
										...
										<tbody>
											...
											<tr>
												...
												<td >
													<!--Row Delete Start -->
													<a href="<?php echo site_url(); ?>admin/fee_payment/delete/<?php echo $row['fee_payment_id'];?>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="Remove"><i class="fa fa-times fa fa-white"></i></a>

													<!--Row Delete End -->

													<!-- Row Edit Start-->

													<a  data-toggle="modal" data-target="#modal-edit<?php echo $row['fee_payment_id'];?>"  href="" class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>


										            <!-- Modal -->
										            <div class="modal fade" id="modal-edit<?php echo $row['fee_payment_id'];?>">
										              <div class="modal-dialog">
										                <div class="modal-content">
										                  <div class="modal-header">
										                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
										                      <span aria-hidden="true">&times;</span></button>
										                    <h4 class="modal-title">Edit Fee Payment</h4>
										                  </div>
										                  <div class="modal-body">
										     
									                        <form method="POST" action="<?php echo site_url(); ?>admin/fee_payment/update/<?php echo $row['fee_payment_id'];?>" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
													           ...
													           <div class="form-group ">
													                ...
													                <div class="col-md-6">
													                    <input class="form-control" name="fine" type="number" id="name" value="<?php echo $row['fine'] ?>">
													           ...
													           <div class="form-group ">
													                ...
													                <div class="col-md-6">
													                    <textarea class="form-control" name="remark" type="text" id="name"><?php echo $row['remark'] ?></textarea> 
													           ...
													           <div class="form-group ">
													                ...
													                <div class="col-md-6">
													                    <input class="form-control" name="  reference_number" type="text" id="name" value="<?php echo $row['reference_number'] ?>">
													...
													<a  data-toggle="modal" data-target="#modal-view<?php echo $row['fee_payment_id'];?>" class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="View"><i class="fa fa-eye"></i></a>

										            <!-- Modal -->
										            <div class="modal fade" id="modal-view<?php echo $row['fee_payment_id'];?>">
										              <div class="modal-dialog">
										                <div class="modal-content">
										                  <div class="modal-header">
										                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
										                      <span aria-hidden="true">&times;</span></button>
										                    <h4 class="modal-title">Show Fee Payment</h4>
										                  </div>
										                  <div class="modal-body">
						              ...
						              <div class="modal-dialog">
						                <div class="modal-content">
						                  <div class="modal-header">
						                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
						                      <span aria-hidden="true">&times;</span></button>
						                    <h4 class="modal-title">Add New Fee Payment</h4>
						                  </div>
						                  <div class="modal-body">
						     
						                        <form method="POST" action="<?php echo site_url(); ?>admin/fee_payment/store/" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
	                                                    ...
	                                                    <div class="form-group ">
	                                                        <label for="name" class="col-md-4 control-label">Student</label>
	                                                        <div class="col-md-6">
	                                                            <select class="form-control" name="student_id" id="student_id-create" required="required" onchange="get_fee_form(this.value);get_month(this.value);">
	                                                            </select>
	                                                              
	                                                        </div>
	                                                    </div>		                            
	                                                    <div class="form-group ">
	                                                        <label for="name" class="col-md-4 control-label">Payment Month</label>
	                                                        <div class="col-md-6">
	                                                            <select class="form-control" name="payment_month" id="month-create" required="required">
	                                                            </select>
...
<script>
    function get_student_list_by_class(val) {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url(); ?>admin/ajax_function/get_student_list_by_class",
            data: 'class_id=' + val,
...
<script>
    function get_fee_form(student_id) {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url(); ?>admin/ajax_function/get_fee_form",
