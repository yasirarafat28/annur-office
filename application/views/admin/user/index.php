									...
									<table class="table table-bordered table-striped table-hover  dataTable" id="example" >
										...
										<tbody>
											...
											<tr>
												...
												<td >
													<!--Row Delete Start -->
													<a href="<?php echo site_url(); ?>admin/user/delete/<?php echo $row['admin_id'];?>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="Remove"><i class="fa fa-times fa fa-white"></i></a>
