									...
									<div>
	          							...
	          							<form class="form-inline" method="GET" id="search">
										    <div class="form-group">
										      <a  data-toggle="modal" data-target="#modal-create" href="" class=" btn btn-primary form-control" title="Add New Expense" style="border-radius: 0px"><i class="fa fa-plus" aria-hidden="true"></i> Add New Expense</a>
										    </div>
									...
									<table class="table table-bordered table-striped table-hover  dataTable" id="example" >
										...
										<tbody>
											...
											<tr>
												...
												<td >
													<!--Row Delete Start -->
													<a href="<?php echo site_url(); ?>admin/expense/delete/<?php echo $row['transaction_id'];?>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="Remove"><i class="fa fa-times fa fa-white"></i></a>
										              ...
										              <div class="modal-dialog">
										                <div class="modal-content">
										                  ...
										                  <div class="modal-body">
									                        ...
									                        <form method="POST" action="<?php echo site_url(); ?>admin/expense/update/<?php echo $row['transaction_id'];?>" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
			                                                    ...
			                                                    <div class="form-group ">
			                                                        ...
			                                                        <div class="col-md-6">
			                                                            <input class="form-control" name="outgoing" type="namber" id="name" step="any" value="<?php echo $row['outgoing']; ?>">
										                  ...
										                  <div class="modal-body">
									                        ...
									                        <form method="POST" action="" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
			                                                    ...
			                                                    <div class="form-group ">
			                                                        <label for="name" class="col-md-4 control-label">Amount</label>
			                                                        <div class="col-md-6">
								                                    	<p class="form-control"><?php echo $row['outgoing'] ?></p>
						              ...
						              <div class="modal-dialog">
						                <div class="modal-content">
						                  ...
						                  <div class="modal-body">
						                        ...
						                        <form method="POST" action="<?php echo site_url(); ?>admin/expense/store/" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="name" class="col-md-4 control-label">Amount</label>
                                                        <div class="col-md-6">
                                                            <input class="form-control" name="outgoing" type="namber" id="name" step="any">
