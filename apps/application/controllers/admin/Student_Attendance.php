...
class Student_Attendance extends CI_Controller {
    ...
    public function index() {
        ...
        $data=  [
            'panel_name'      =>  'Admin',
            'page_name'       =>    'Student Attendance',

            'classes'        =>     $classes,
            'students'        =>     $students,
        ];

        $this->load->view('admin/student_attendance/index',$data);
    }
    ...
    public function store() {
        ...
        {   
            ...
            $this->session->set_flashdata('success', 'Student Attendance Inserted Successfully');
            redirect('admin/student_attendance/?class_id='.$this->input->post('class_id'));
