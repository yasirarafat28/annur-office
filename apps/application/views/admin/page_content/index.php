									...
									<div>
	          							...
	          							<form class="form-inline" method="GET">
										    <div class="form-group">
										      <a  data-toggle="modal" data-target="#modal-create" href="" class=" btn btn-primary form-control" title="Add New Notice" style="border-radius: 0px"><i class="fa fa-plus" aria-hidden="true"></i> Add New Post</a>
										    </div>
										  </form>
										                ...
										                <div class="modal-content">
										                  ...
										                  <div class="modal-body">
									                        ...
									                        <form method="POST" action="<?php echo site_url(); ?>admin/noticeboard/update/<?php echo $row['notice_id'];?>" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								                            	...
								                            	<div class="form-group ">
								                                    <label for="name" class="col-md-4 control-label">News Title</label>
								                                    <div class="col-md-6">
								                                ...
								                                <div class="form-group ">
								                                    <label for="name" class="col-md-4 control-label">News</label>
								                                    <div class="col-md-6">
