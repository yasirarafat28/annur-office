                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form class="form-inline" method="GET">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <select class="form-control" name="subject_id"  onchange="get_mark_edit_form( $('#class_id').val(), $('#exam_id').val(), this.value )" id="subject_id">
                                                    ...
                                                    <form method="POST" action="<?php echo site_url(); ?>admin/mark/update/" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">

                                                        <div id="mark-edit-form"></div>
...
<script>
    function get_mark_edit_form(class_id,exam_id,subject_id) {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url(); ?>admin/ajax_function/get_mark_edit_form",
            data:'class_id='+class_id+'&exam_id='+exam_id+'&subject_id='+subject_id,
            success: function (data) {
                $("#mark-edit-form").html(data);
            }
        });
    }
</script>
