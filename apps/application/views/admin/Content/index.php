                                    ...
                                    <div>
                                        ...
                                        <form class="form-inline" method="GET">
                                            <div class="form-group">
                                              <a  data-toggle="modal" data-target="#modal-create" href="" class=" btn btn-primary form-control" title="Add New Notice" style="border-radius: 0px"><i class="fa fa-plus" aria-hidden="true"></i> Add Content</a>
                                            </div>
                                          </form>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="8%">
                                                    ...
                                                    <!--Row Delete Start -->
                                                    <a href="<?php echo site_url(); ?>admin/content/delete/<?php echo $row['content_id'];?>" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="Remove"><i class="fa fa-times fa fa-white"></i></a>

                                                    <!--Row Delete End -->

                                                    <!-- Row Edit Start-->

                                                    <a  data-toggle="modal" data-target="#modal-edit<?php echo $row['content_id'];?>"  href="" class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>


                                                    <!-- Modal -->
                                                    <div class="modal fade" id="modal-edit<?php echo $row['content_id'];?>">
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            ...
                                                            <form method="POST" action="<?php echo site_url(); ?>admin/content/update/<?php echo $row['content_id'];?>" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <textarea id="summernote" class="form-control summernote" name="description" type="text"><?php echo $row['description']; ?></textarea>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <a  data-toggle="modal" data-target="#modal-view<?php echo $row['content_id'];?>" class="btn btn-success btn-xs tooltips" tooltip-placement="top" title="View"><i class="fa fa-eye"></i></a>

                                                    <!-- Modal -->
                                                    <div class="modal fade" id="modal-view<?php echo $row['content_id'];?>">
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                                ...
                                                <form method="POST" action="<?php echo site_url(); ?>admin/content/store/" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">

                                                        <div class="form-group ">
                                                        <label for="name" class="col-md-2 control-label">Page Type</label>
                                                        <div class="col-md-10">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea id="summernote" class="form-control summernote" name="description" type="text"></textarea>
                                                            </div>
                                                        </div>
