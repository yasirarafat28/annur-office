...
else if(document.registration.password_again.value=="")
{
alert("New Password Filed is Empty !!");
document.registration.password_again.focus();
return false;
}
else if(document.registration.password_again.value!= document.registration.password.value)
{
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-register">
					<form name="registration" id="registration" onSubmit="return valid();"  method="post">
						<fieldset>
							<legend>
								Sign Up
							</legend>
