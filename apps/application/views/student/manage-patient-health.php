...
<html lang="en">
	<head>
		<title>Doctor | Patient Health Report</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor  |  Patient Health Report</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Doctor </span>
...
?>
											...
											<tr>
												...
												<div class="visible-md visible-lg hidden-sm hidden-xs">
													<a type="button"  data-toggle="modal" data-target="#myModal<?php echo $cnt;?>">Details</a>
												</div>
...
$cnt=$cnt+1;
								...
								<div class="modal fade clearfix" id="myModal<?php echo $count;?>" role="dialog">
							    <div class="modal-dialog">
							      ...
							      <div class="modal-content">
							        <div class="modal-header">
							          ...
							          <h4 class="modal-title">Patient Health Details</h4>
							        </div>
