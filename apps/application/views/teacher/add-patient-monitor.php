                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Add Patient Health</h1>
                                </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="panel panel-white">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">Add Patient Health</h5>
                                                </div>
                                                <div class="panel-body">
                                                    ...
                                                    <form role="form" name="adddoc" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select  class="form-control" name="appointmentId">
                                                                ...
                                                                foreach ($patients as $row) {
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $row['appointmentId'];?>"><?php echo $row['fname'];?></option>
                                                                    <?php
                                                                    # code...appointment_id
                                                                }
                                                                ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="MetsbolicSyndrome" id="room_code" class="form-control"  placeholder="Enter Metabolic Syndrome">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                Blood Pressure
                                                            </label>
                                                            <input type="text" name="BloodPressure" id="room_code" class="form-control"  placeholder="Enter Metabolic Syndrome">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                HDC Cholesterol
                                                            </label>
                                                            <input type="text" name="HDCholesterol" id="room_code" class="form-control"  placeholder="Enter HDC Cholesterol">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                LDC Cholesterol
                                                            </label>
                                                            <input type="text" name="LDCholesterol" id="room_code" class="form-control"  placeholder="Enter LDC Cholesterol">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                Triglycerides
                                                            </label>
                                                            <input type="text" name="Triglycerides" id="room_code" class="form-control"  placeholder="Enter  Triglycerides">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                LiverEnzyme
                                                            </label>
                                                            <input type="text" name="LiverEnzyme" id="room_code" class="form-control"  placeholder="Enter LiverEnzyme">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                Body Mass
                                                            </label>
                                                            <input type="text" name="BodyMass" id="room_code" class="form-control"  placeholder="Enter BodyMass">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                Abnormal Circumference
                                                            </label>
                                                            <input type="text" name="AbnormalCircumference" id="room_code" class="form-control"  placeholder="Enter AbnormalCircumference">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                Physical Condition
                                                            </label>
                                                            <input type="text" name="PhysicalCondition" id="room_code" class="form-control"  placeholder="Enter PhysicalCondition">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="roomcode">
                                                                Diabetes
                                                            </label>
                                                            <input type="text" name="Diabetes" id="room_code" class="form-control"  placeholder="Enter Diabetes">
                                                        </div>
